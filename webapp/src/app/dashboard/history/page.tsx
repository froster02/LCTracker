    ...
    return (
      <>
        ...
        <main className="mx-auto max-w-lg px-4 py-24 text-center">
          ...
          <p className="mb-8 text-muted-foreground">Sign in to view your submission history.</p>
          <button
  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-7xl px-4 py-8">
        <h1 className="mb-8 text-2xl font-bold">Submission History</h1>
        <Card>
          <CardHeader>
            <CardTitle className="text-sm font-medium">
              All Submissions ({pagination.total} total)
            </CardTitle>
          </CardHeader>
          <CardContent>
            {loading ? (
